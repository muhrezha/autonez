                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        {infoPosts.map((post) => (
                            <Link
                                key={post.id}
                                href={`/info/${post.id}`}
                                className="group flex flex-col rounded-2xl border border-slate-100 overflow-hidden bg-white hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-1 transition-all duration-500"
                            >
                                {/* Thumbnail */}
                                <div className="relative h-56 overflow-hidden bg-slate-100">
                                    ...
                                    />
                                    {/* Category badge */}
                                    <span className="absolute top-4 left-4 px-3 py-1 text-[10px] font-bold tracking-wider uppercase bg-primary text-white rounded-full">
                                        {post.category}
                                    </span>
                                </div>
                                ...
                                <div className="flex flex-col flex-1 p-6">
                                    ...
                                    {/* Title */}
                                    <h2
                                        className="text-lg font-bold text-navy mb-3 group-hover:text-primary transition-colors leading-snug"
                                        style={{ fontFamily: "var(--font-heading)" }}
                                    >
                                        {post.title}
                                    </h2>
